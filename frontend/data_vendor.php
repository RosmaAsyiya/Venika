        ...
        <main>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <ul>
                                        <?php echo '<li>Whatsapp : <a href="#" class="product-link">https://wa.me/' . $no_hp . '</a>';
                                        echo '</li>';
                                        echo '<li>Instagram : <a href="#"';
                                                echo 'class="product-link">https://www.instagram.com/' . $instagram . '</a></li>';
                                        echo '<li>Twitter : <a href="#" class="product-link">https://www.twitter.com/' . $twitter . '</a></li>';
                                        echo '<li>Facebook : <a href="#" class="product-link">https://www.facebook.com/' . $facebook . '</a></li>';
                                        echo '<li>Website : <a href="#" class="product-link">' . $website . '</a></li>';?>
                                    </ul>
                                </td>
                        ...
                        <div class="modal-body">
                            <form class="needs-validation">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="" placeholder="fasilitas yang disediakan..." id="classic" cols="30"
                                        rows="10"></textarea>
                                </div>
            ...
            <div class="modal fade" id="menu" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Variasi Menu Vendor</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <form class="needs-validation">
                                ...
                                <div class="mb-3">
                                    <label for="message-text" class="col-form-label">Variasi Menu</label>
                                    <textarea name="" placeholder="Masukkan variasi/nama/paket/menu yang tersedia..."
            ...
            <div class="modal fade" id="kontak" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Kontak Vendor</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <form class="needs-validation">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="" placeholder="(Nomor/Link/Nama) Whatsapp, Instagram, Website"
                                        id="classic" cols="30" rows="10"></textarea>
                                </div>
